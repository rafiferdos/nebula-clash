...
import BannerResults from '../pages/Home/BannerResults';
...
const Banner = () => {
    ...
    return (
        <>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="join">
                                <label className="input input-bordered flex items-center gap-2 glass rounded-full join-item">
                                    <input type="text" className="grow input-sm md:input-md lg:input-lg" placeholder="Search Contests..." {...register('search')} />
                                </label>
                                <button className="btn join-item rounded-full glass" type="submit">
            ...
            <BannerResults searchTerm={searchTerm} />
        </>
    );
};
